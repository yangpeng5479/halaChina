...
@interface GDNewArrivedViewController ()

@end

@implementation GDNewArrivedViewController
...
- (id)init:(int)vendor_id
{
    ...
    if (self)
    {
        ...
        self.title = NSLocalizedString(@"New Arrivals", @"每日上新");
    ...
    [manager POST:url
       parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         if (status==1)
         {
             ...
             [productList addObjectsFromArray:responseObject[@"data"][@"product_list"]];
