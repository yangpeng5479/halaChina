...
@interface GDNewDealsViewController ()

@end

@implementation GDNewDealsViewController
...
//    NSDictionary* parameters = @{@"language_id":@([[GDSettingManager instance] language_id:NO]),@"page":@(seekPage),@"limit":@(prePageNumber),@"country_id":@([GDSettingManager instance].currentCountryId),@"longitude":@([[GDSettingManager instance] getCityLongitude]),@"latitude":@([[GDSettingManager instance] getCityLatitude])};
    
    NSDictionary* parameters = @{@"language_id":@([[GDSettingManager instance] language_id:NO]),@"page":@(seekPage),@"limit":@(prePageNumber),@"collection_id":@(29)};
...
{
    [super viewDidLoad];
    self.title = NSLocalizedString(@"HOT",@"热门");
