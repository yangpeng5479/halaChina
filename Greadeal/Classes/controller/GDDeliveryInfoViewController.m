//
//  GDDeliveryInfoViewController.m
//  Greadeal
//
...
@interface GDDeliveryInfoViewController ()

@end

@implementation GDDeliveryInfoViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if  (indexPath.section == 0)
    {
        if (indexPath.row == 0)
        {
            ...
            cell.textLabel.text= [NSString stringWithFormat:@"%@: %@",NSLocalizedString(@"Phone", @"电话"),phone];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0 && indexPath.row == 0)
    {
        ...
        [[GDPublicManager instance] makeCall:phone withView:self.view];
    }
}
