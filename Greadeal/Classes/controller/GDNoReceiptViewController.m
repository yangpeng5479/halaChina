...
#import "GDNoReceiptViewController.h"
#import "RDVTabBarController.h"

#import "GDOrderListCell.h"

@interface GDNoReceiptViewController ()

@end

@implementation GDNoReceiptViewController
...
- (id)init
{
    ...
    if (self)
    {
        ...
        self.title = NSLocalizedString(@"Orders Awaiting Shipment", @"待收货");
    }
...
- (UIView *)noReceiptView
{
    if (!_noReceiptView) {
        ...
        [goBut setLabelFont:[UIFont systemFontOfSize:18]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    else if (indexPath.row ==2)
    {
        ...
        [seeBut setTitle:NSLocalizedString(@"Tracking order", @"查看物流") forState:UIControlStateNormal];
