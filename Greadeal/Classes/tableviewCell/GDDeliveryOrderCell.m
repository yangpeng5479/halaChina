...
@implementation GDDeliveryOrderCell
...
-(void)layoutSubviews
{
    ...
    //self.photoView.frame = CGRectMake(xMargin, yMargin,photoWidth, photoHeigth);
    
    float offsetX = xMargin;
    float offsetY = yMargin;
    
    self.title.frame = CGRectMake(offsetX, offsetY,
                                  [GDPublicManager instance].screenWidth-xMargin*2, titleHeight);
...
//        self.photoView.frame = tempRect;   tempRect = self.title.frame;
