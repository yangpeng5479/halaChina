...
-(void)bootstrapStyle{
    ...
    [self.titleLabel setFont:MOLightFont(self.titleLabel.font.pointSize)];
}
...
-(void)defaultStyle{
    ...
    self.titleLabel.font = MOLightFont(16);

    [self setBackgroundImage:[self buttonImageFromColor:[UIColor grayColor]] forState:UIControlStateHighlighted];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor greenColor]] forState:UIControlStateSelected];
}
...
-(void)primaryStyle{
    ...
    self.titleLabel.font = MOBlodFont(30);
}
...
-(void)successStyle{
    ...
    self.titleLabel.font = MOBlodFont(24);
}
...
- (void)addAwesomeIcon:(FAIcon)icon beforeTitle:(BOOL)before
{
    ...
    self.titleLabel.font = MOLightFont(self.titleLabel.font.pointSize);
