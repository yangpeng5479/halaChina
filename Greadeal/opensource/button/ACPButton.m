...
#define kLabelFont MOLightFont(15)
...
- (void)addShareImage
{
    UIImageView* shareimage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"coupon_share.png"]];
    shareimage.frame = CGRectMake(6, 6, 20, 19);
    [self addSubview:shareimage];
}

- (void)setStyleYellowButton
{
    [self setStyleWithImage:@"button_normal.png" highlightedImage:@"button_pressed.png" disableImage:@"button_disable.png" andInsets:UIEdgeInsetsMake(5.0f, 5.0f, 5.0f, 5.0f)];
    [self setLabelTextColor:[UIColor whiteColor] highlightedColor:[UIColor whiteColor] disableColor:[UIColor whiteColor]];
    [self setCornerRadius:0];
    
}
- (void)setStyleRedButton
{
    [self setStyleWithImage:@"button_red.png" highlightedImage:@"button_red.png" disableImage:@"button_disable.png" andInsets:UIEdgeInsetsMake(5.0f, 5.0f, 5.0f, 5.0f)];
