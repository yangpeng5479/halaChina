...
static NSTimeInterval const kINSSearchBarAnimationStepDuration = 0.0;
...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame), CGRectGetWidth(frame), 34.0)]))
	{
		...
		self.searchField.font = MOLightFont(16);
		...
		self.searchImageViewOff.image = [UIImage imageNamed:@"NavBarIconSearch_blue"];
