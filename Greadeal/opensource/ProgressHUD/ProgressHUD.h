...
//-------------------------------------------------------------------------------------------------------------------------------------------------
#define HUD_STATUS_FONT			MOBlodFont(16)
#define HUD_STATUS_COLOR		[UIColor blackColor]

#define HUD_SPINNER_COLOR		[UIColor colorWithRed:(63/255.0) green:(211/255.0) blue:(122/255.0) alpha:0.8]
...
#define HUD_IMAGE_REMIND		[UIImage imageNamed:@"ProgressHUD.bundle/remind.png"]
//-------------------------------------------------------------------------------------------------------------------------------------------------
...
+ (void)showRemind:(NSString *)status;
