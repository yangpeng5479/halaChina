...
{
    [self shared].interaction = YES;
    [[self shared] hudMake:status image:HUD_IMAGE_REMIND spin:NO hide:YES];
}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    if (label.hidden && image.hidden)
        hudWidth = 50, hudHeight = 50;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	if (label.text != nil)
	{
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	@autoreleasepool
	{
		...
		NSTimeInterval sleep = length * 0.15 + 0.3;
