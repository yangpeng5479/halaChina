   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.alertTitleLabel.font = MOBlodFont(20);
        ...
        self.alertContentLabel.font = MOLightFont(15);
        ...
        self.leftBtn.titleLabel.font = self.rightBtn.titleLabel.font = MOBlodFont(14);
